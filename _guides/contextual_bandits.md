...
This guide describes how to approach a contextual bandit problem with Vowpal Wabbit. It features a Python tutorial and an overview of the contextual bandit problem using Vowpal Wabbit—including when and how to work with different contextual bandit approaches, how to format test data, and understand the results. 
