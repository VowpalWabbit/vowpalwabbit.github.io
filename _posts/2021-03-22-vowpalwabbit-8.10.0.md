...
- [Move rapidjson to ext_libs folder. Fix fmt/spdlog install (#2870)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [Add test for interact reduction (#2850)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [[test] check for missing test ids (#2860)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [Remove search v_array misuse (#2840)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [v_array unit tests (#2830)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [Make -q :: faster by calculating interactions on the fly instead of pre calculating them (#2807)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [Consolidate ostream inner sink to using VW::io::writer framework (#2801)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
- [Consolidate get_observed_cost implementations (#2792)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/2792)
- [Add more tests for interactions (#2806)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
- [[nn] fix double free (#2802)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
- [Refactor trace_message and vw_ostream to allow for arbitrary streambuf objects (#2800)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [[test] fix exception message of test (#2770)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [Implement 1-slot continuous CB (#2410)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
- [Add python bindings for pdf prediction type (#2744)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/2744)
- [Fix missing progressive validation header (#2750)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
- [Update types used as option input (#2734)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/2734)
- [redirect cerr and cout (#2710)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [Adding a new line at the end of 2 multiline tests (#2740)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [[cbify] Fix dangling pointer in example due prediction array caching. (#2730)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [Vcpkg do not link everything (#2720)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
- [Update run-benchmarks.sh (#2723)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/2723)
- [Fix MacCI: uninstall openssl not needed anymore](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [make options a unique_ptr (#2705)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
- [Fix issue with index in DFtoVW.empty_col (#2703)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
- [Turn CCB sanity checks into reported errors (#2698)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/2698)
- [Make a copy when doing text based parsing (#2706)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
- [[py] Run parser automatically based on str (#2702)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
- [Run doctest in Python CI (#2708)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
- [Fix examples in python lib docs (#2707)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
- [renaming (#2704)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
- [Add test to check regression of dsjson in python (#2699)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/2699)
- [Update vw.h (#2700)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [Use variable for port (#2701)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [Do not go up directory in test definitions (#2690)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [Stream flatbuffers instead of reading entire file (#2670)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [Fix options warnings on macos (#2660)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [Update build_python_wheels_macos.yml (#2650)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
...
- [Update PACKAGE.rst (#2640)](https://github.com/VowpalWabbit/vowpal_wabbit/pull/unknown)
